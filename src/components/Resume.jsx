        ...
        <div className="border border-gray-200 dark:border-gray-800 p-4 rounded-md max-w-4xl mx-auto shadow-lg">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 mb-6">
            <a
              ...
              className="flex w-full md:w-1/2 items-center justify-center gap-2 px-4 py-2 border border-gray-200 dark:border-gray-800 rounded-md text-sm font-medium text-gray-800 dark:text-gray-50 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors animate-fade-up"
              download
            >
