...
const TechItem = ({ name, icon: Icon, color }) => (
  <div className="flex flex-shrink-0 items-center rounded-full bg-white dark:bg-gray-800 px-3 py-2 text-xs font-medium text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-800/30 animate-fade-up">
