...
import ProjectImage from '../../assets/projects/PokemonUnite.png';

export const projectData = {
    id: 'pokemon-unite-project',
    title: 'Pokémon Unite Landing Page',
    description:
        'A bold and playful design concept for a Pokémon Unite landing page experience.',
    image: ProjectImage,
    tech: ['Figma'],
    sourceCodeLink: '',
    liveDemoLink: '',
...
const PokemonUniteProject = () => {
    const navigate = useNavigate();
    const { liveDemoLink, title } = projectData;
...
export default PokemonUniteProject;
